...
(function () {
  ...
  const cpSwiper_2 = new Swiper('.cpSlider_2 .swiper', {
    slidesPerView: 4,
    spaceBetween: 20,
    loop: false,
    // 切換點
    pagination: {
      el: '.cpSlider_2 .swiper-dots',
      bulletElement: 'button',
      clickable: true,
    },
    // 切換箭頭
    navigation: {
      nextEl: '.cpSlider_2 .swiperArrow.next', //自行設定樣式
      prevEl: '.cpSlider_2 .swiperArrow.prev', //自行設定樣式
      disabledClass: 'swiperArrow-disabled', //不可點選樣式
    },
    breakpoints: {
      100: {
